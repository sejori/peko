...
import { devMode, cssGlob, reloadDelay } from "../../config.js"
import htmlTemplate from "../utils/template.js"
import { setCache } from "../utils/cacher.js"

const decoder = new TextDecoder()

export const ssrHandler = async (request, pageUrl, bundleUrl) => {
    const pageImport = await import(pageUrl)
