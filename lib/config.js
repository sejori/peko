...
// location of client dependencies file
const depsFile = `${Deno.cwd()}/src/deps.js`

// JSON of client dependencies with corresponding URLs
const depsImport = await import(depsFile)
export const deps = depsImport.default 