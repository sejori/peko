...
<p>
    Better yet, Peko is not build for any specific frontend framework or library. You can use barebones HTML, React, Preact, Vue... you name it (if you do set up a React or Vue project please consider adding it to the examples). Simply plug your app-rendering logic into the <a href="https://doc.deno.land/https://deno.land/x/peko/handlers/ssr.ts">SSRHandler</a> with a <a href="https://doc.deno.land/https://deno.land/x/peko/handlers/ssr.ts/~/Render">Render</a> function.
</p>
<p>
